...
describe('DashboardComponent', () => {
  ...
  let spaceXData;
  beforeEach(async(() => {
    //Testbed allows to test both the component and template running together
    mockDataService = jasmine.createSpyObj(['getAllData']);
  ...
  beforeEach(() => {
    //wrapper for component with added properties
    spaceXData = [
      {
        flight_number: 1,
